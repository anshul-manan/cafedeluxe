<script language="javascript" type="text/javascript" runat="server">
    ...
    var storename = "1001339785"; // Replace with your Storenumber here 
    var sharedSecret = "35383733393339303730363333303039343235323932393836313737353836383930383634353936373738303535333937353838353239363331323136323831"; //Replace with your Shared Secret here
    
    /* If you don't want to set the Default TimeZone, then you have to do the following 
    ...
    **/
    ...
    function defaultTime() { d = new Date(); utc = d.getTime() + (d.getTimezoneOffset() * 60000); nd = new Date(utc + (3600000 * 5.5)); strdate = nd.getYear() + ":" + pad(nd.getMonth() + 1, 2) + ":" + pad(nd.getDate(), 2) + "-" + pad(nd.getHours(), 2) + ":" + pad(nd.getMinutes(), 2) + ":" + pad(nd.getSeconds(), 2); return strdate; } function getServerTime() { nd = new Date(); strdate = nd.getYear() + ":" + pad(nd.getMonth() + 1, 2) + ":" + pad(nd.getDate(), 2) + "-" + pad(nd.getHours(), 2) + ":" + pad(nd.getMinutes(), 2) + ":" + pad(nd.getSeconds(), 2); return strdate; } function pad(number, length) { var str = '' + number; while (str.length < length) { str = '0' + str; } return str; } function getTimeZone() { return timezone; } function getStoreName() {
        return storename; } function getSharedSecret() { return sharedSecret; } function getFormattedDate() { return formattedDate; } </script>