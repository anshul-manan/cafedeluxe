...
<asp:MultiView runat="server" ID="mvCart">
    <asp:View runat="server" ID="viewSplash">
        <table border="0" width="100%" align="left" cellspacing="0" cellpadding="5">            
	        ...
	        <tr>
		        <td colspan="2"><p align="center">For Gift Card questions and assistance,<br />please contact our office at 202.362.9842 (ext. 13).<br /><em>Minimum per card purchase: $20 / Maximum per card purchase: $500</em></p></td>
	        </tr>
	        <tr> 
	            <td  align="left" valign="middle" colspan="2" style="height: 80px" class="tabletext">
					...
					<h2>TERMS OF USE</h2>
                    <p>Present this gift card to pay for food and beverage purchases at Cafe Deluxe or Tortilla Coast. The card value will not be replaced if card is lost, stolen, damaged or used without your permission. Unused value remains on card and cannot be redeemed for cash or applied for gratuities. Additional value may be added to this card at any time. After 12 months of non-use, a $5 per month fee will be deducted from the remaining balance until depleted, unless prohibited by law.</p>
