      ...
      <tr>
        ...
        <div class="nav">
        	<ul>
                ...
                <div class="frequent-dining"><a href="frequent-dining.asp"><img src="images/frequent-dining-program.gif" alt="Frequent Dining Program" border="0" /></a></div>       
        </div></td>
...
<span class="tabletext">
          <table width="470" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <p>Cafe Deluxe and Tortilla Coast proudly support numerous local and neighborhood charities and organizations.</p>
              <p>We do not accept phone requests, so please submit your solicitation via:</p>
                <ul style="text-align:left;">
  <li style="padding-bottom:5px;"><strong>Email</strong>, using the form above</li>
                  <li><strong>Regular Mail</strong> to:<br />
					  5272 River Road<br />Suite 650<br />
					  Bethesda, MD 20816</li>
              </ul></td>
              </tr>
          </table>
</span></td>
