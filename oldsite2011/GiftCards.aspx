...
<asp:MultiView runat="server" ID="mvCart">
    <asp:View runat="server" ID="viewSplash">
        <table border="0" width="100%" align="left" cellspacing="0" cellpadding="5">            
            <tr class="header"> 
	            <td align="center" valign="middle"><img src="lib/images/gc.gif" alt="" border="0"></td>
            ...
            <tr>
	            <td colspan="2" style="border-top:1px solid #000; border-bottom:1px solid #000; text-align:center; padding:3px 0;"><p style="color:#CC0000; text-transform:uppercase; font-weight:bold;">OR</p></td>
            </tr>
	        ...
	        <tr> 
	            <td  align="left" valign="middle" colspan="2" style="height: 80px"> 
					<!--<img src="images/bannerHoliday.jpg" alt="Happy Holidays" title="Happy Holidays" /><br />-->
	                <p style="color:#CC0000; text-transform:uppercase; font-weight:bold;">Purchase a Gift Card Online</p>
					...
					<p style="color:#CC0000; text-transform:uppercase; font-weight:bold;">Corporate Gifts</p>
