...
<asp:MultiView runat="server" ID="mvCart">
    <asp:View runat="server" ID="viewSplash">
        <table border="0" width="511" align="left" cellspacing="0" cellpadding="5">            
            <tr class="header"> 
	            <td align="center" valign="middle"><img src="lib/images/gc2.gif" alt="" border="0" style="padding-bottom:10px;"></td>
                    ...
                    <form id="Form1" runat="server">
			            <table>
				            ...
				            <tr>
					            ...
					            <td style="width: 170px">
					                <asp:TextBox runat="server" ID="txtAmount" Columns="10" MaxLength="6" Width="65px" />
            ...
            <tr>
	            <td colspan="2" align="center" style="border-top:1px solid #000; border-bottom:1px solid #000;"><p style="color:#C00;"><strong>OR</strong></p></td>
            </tr>
            <tr class="header" style="text-align: center">
	            <td colspan="2">
   	                <p><strong>Check your Current Balance:</strong>&nbsp;<button class="button"  onClick="popChat()";>Check Card Balance</button></p>
	            </td>
            </tr>
	        <tr>
		        <td colspan="2">For Gift Card questions, please contact our office at <span style="color: #A10A14;">(202) 362-9842</span>. Minimum per card purchase $20, maximum per card purchase $500.</td>
	        </tr>
	        <tr> 
	            <td  align="left" valign="middle" colspan="2" style="height: 80px" class="bodytext"> 
					<!--<img src="images/bannerHoliday.jpg" alt="Happy Holidays" title="Happy Holidays" /><br />-->
	                <p style="color:#C00;"><strong>PURCHASE A GIFT CARD ONLINE</strong></p>
		            The Cafe Deluxe Gift Card makes a great present for friends, family, teachers or business associates. They can be used at any of our four locations.
					...
					<p style="color:#C00;"><strong>CORPORATE GIFTS</strong></p>
                    Corporate and large-scale private purchases of Cafe Deluxe Gift Cards are available at a discounted price of 25% on amounts of $5,000 and greater. They are available only from our Corporate Office, not through the restaurants or Internet orders.  Discounts are awarded as additional Gift Cards. For example, if you were to order $5,000 in Gift Cards you would receive $1,250 in additional Cafe Deluxe Gift Cards.

                    <p><blockquote>Contact our Gift Card Manager at, 202-362-9842 extension 05. He will assist you, answer any questions you have, and personally take your order.</blockquote></p>
</p>
    		    </td>
    	    </tr>
        </table>
    ...
    <table border="0" width="511" align="left" cellspacing="0" cellpadding="5">
        <tr>
            <td align="left" valign="middle" colspan="4">
                <h3 style="color:#C00;"><strong><asp:label runat="server" ID="lblProgress">Step 2 of 4 : Checkout</asp:label></strong></h3>
            </td>
        </tr>
        <tr>
            <td align="left" valign="middle" colspan="4">
    ...
    <table border="0" width="511" align="left" cellspacing="0" cellpadding="5">
         <tr class="header">
            <td colspan="6"><p style="color:#C00;"><strong>CARD MESSAGE</strong></p></td>
        </tr> 
        <tr class="background">
...
<!-- Begin Billing Section -->
        <tr class="header">
            <td colspan="6"><p style="color:#C00;"><strong>BILLING INFORMATION</strong></p></td>
        </tr>
        <tr class="background">
        ...
        <tr class="header">
            <td colspan="6"><p style="color:#C00;"><strong>SHIPPING INFORMATION</strong></p></td>
        </tr>
        <tr class="background">
            <td colspan="6" align=left>
                <table width="100%" cellpadding=0 cellspacing=0>
                    <tr>
                        ...
                        <td><br />
                            If your shipping information is the same as your billing<br />information, check the box below and click "Submit". You do not need to provide your address again.<br /><br />
                        </td>
                        <td width=15%>
        ...
        <tr>
            <td>
                 <table border="0" width="511" align="left" cellspacing="0" cellpadding="5">
                    <tr>
                        <td align="left" valign="middle" colspan="4">
                            <h3 style="color:#C00;"><strong><asp:label runat="server" ID="Label1">Step 3 of 4 : Confirmation</asp:label></strong></h3>
                            <p>
                    ...
                    <table border="0" width="511" align="left" cellspacing="0" cellpadding="5">
                        <tr class="header">
                            <td class="header" style="text-align:left; width: 30%;">
                                <p style="color:#C00;"><strong><asp:Label ID="Label21" runat="server" Text="CARD MESSAGE" Width="148px"></asp:Label></strong></p></td>
                                <td align=right>
            ...
            <tr>
                <td style="height: 408px">
                    <table border="0" width="511" align="left" cellspacing="0" cellpadding="5">
                        <tr class="header">
                            <td class="header" style="text-align:left;" width=30%>
                                <p style="color:#C00;"><strong><asp:Label ID="Label6" runat="server" Text="BILLING INFORMATION" Width="148px"></asp:Label></strong></p></td>
                                <td align=right>
            ...
            <tr>
                <td>
                    <table border="0" width="511" align="left" cellspacing="0" cellpadding="5">
                        <tr class="header">
                            <td>
                                <p style="color:#C00;"><strong><asp:Label ID="Label7" runat="server" Text="SHIPPING INFORMATION" Width="148px"></asp:Label></strong></p></td>
                                <td align=right>
