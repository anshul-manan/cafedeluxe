...
<body onload="PushForm();">
    <form id="form1" action="https://secure.linkpt.net/lpcentral/servlet/lppay" method="post" name="form1">
        <input id="bPost" type="hidden" value="" runat=server/>
        
        <INPUT id="storename" runat=server type="hidden" name="storename" value="1001171926">
        <INPUT type="hidden" name="mode" value="payonly">
        <input type="hidden" name="txntype" value="sale" />
        <input type="hidden" name="suppressTitle" value="true">
        
        <input id="chargetotal" runat=server type="hidden" name="chargetotal" value="35.66">
        <input id="subtotal" runat=server type="hidden" name="subtotal" value="25.66">
